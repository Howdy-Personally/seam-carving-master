...
if __name__ == '__main__':
    ...
    output_image_mask = os.path.join(folder_out, "images_mask", filename_output)
    output_image_removal = os.path.join(folder_out, "images_removal", filename_output)
    # print(os.getcwd())
    image_resize_without_mask(input_image, output_image, new_height, new_width)
    # image_resize_with_mask(input_image, output_image_mask, new_height, new_width, input_mask)
    # object_removal(input_image, output_image_removal, input_mask)
